        ...
        create_input: function () {
            ...
            this.input =
				...
				.change(function () {
				    ...
				    if ($(this).attr('name') == 'PricingDataFileInput') {
				        var clone = $(this).clone();
				        clone.attr('id', 'PricingDataFileInputInsert');
				        PricingUploaderInsert.input = clone;
				        //$('input[name="PricingDataFileInputInsert"]').val($(this).val());
        ...
        submit: function () {
            ...
            iframe.load(function () {
                ...
                if (response == 'success') {
                    ...
                    $("#URLImageEditorLisiLKI").val("Hola Query");
                } else {
